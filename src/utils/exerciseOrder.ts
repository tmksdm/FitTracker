...
/**
 * Determines the next direction for a given day type based on the
 * direction used in the last session.
 *
...
/**
 * Determines which direction to use for the next session of a day type.
